...
void loop() {
  ...
  if(time - previousTime >= SAMPLE_PERIOD) {
    ...
    if(bp1 == 0 && previousBp1 == 1 && bp2 == 1 && state == STATE_0) state = STATE_7;
    else if(bp2 == 0 && previousBp2 == 1 && bp1 == 1 && state == STATE_0) state = STATE_8;
    else if(bp1 == 0 && previousBp1 == 0 && bp2 == 0 && previousBp2 == 0 && state == STATE_0) state = STATE_1;
    ...
    else if(state == STATE_7) state = STATE_0;
    else if(state == STATE_8) state = STATE_0;
